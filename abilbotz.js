...
_｢ Sound Menu ｣_
${symbol} ${prefix}sound1
${symbol} ${prefix}sound2
${symbol} ${prefix}sound3
${symbol} ${prefix}sound4
${symbol} ${prefix}sound5
${symbol} ${prefix}sound6
${symbol} ${prefix}sound7
${symbol} ${prefix}sound8
${symbol} ${prefix}sound9
${symbol} ${prefix}sound10
${symbol} ${prefix}sound11
${symbol} ${prefix}sound12
${symbol} ${prefix}sound13
${symbol} ${prefix}sound14
${symbol} ${prefix}sound15
${symbol} ${prefix}sound16
${symbol} ${prefix}sound17
${symbol} ${prefix}sound18
${symbol} ${prefix}sound19
${symbol} ${prefix}sound20
${symbol} ${prefix}sound21
${symbol} ${prefix}sound22
${symbol} ${prefix}sound23
${symbol} ${prefix}sound24
${symbol} ${prefix}sound25

_｢ RANDOM VIDEO ｣_
${symbol} ${prefix}bokep
${symbol} ${prefix}beatvn
${symbol} ${prefix}jedagjedugff
${symbol} ${prefix}jedagjedugml
${symbol} ${prefix}jedagjedugpubg
${symbol} ${prefix}storysholawatan
${symbol} ${prefix}storywa
${symbol} ${prefix}storygalau
${symbol} ${prefix}storytruk
${symbol} ${prefix}storybus
${symbol} ${prefix}storyanime
...
abilbotz.sendMessage(from, omkeh, MessageType.audio, { quoted: mek, mimetype: 'audio/mp4', ptt: true })
break
case 'sound71':
case 'sound71':
case 'sound72':
